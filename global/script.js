...
/*!*********************************!*\
  !*** ./src/js/modules/modal.js ***!
  \*********************************/
/*! exports provided: default, closeModal, openModalWindow */
...
function modal(openModalSelector, modalWindowSelector, modalTimer) {
  ...
  const modalOpen = document.querySelectorAll(openModalSelector),
        modalWindow = document.querySelector(modalWindowSelector); //   modalClose = document.querySelector('[data-close]');
...
function slider({
  ...
  for (let i = 0; i < slides.length; i++) {
    const dot = document.createElement('li'); //        dot.setAttribute('data-slide-to', i + 1);
...
window.addEventListener('DOMContentLoaded', () => {
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-modal]', '.modal');
  /* slider({
